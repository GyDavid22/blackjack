abstract class LanguageTexts {
    ...
    errorDeckOfCardsAPI: string = "There was an error in communicating with Deck of Cards API. Please try again and see if the issue persist.";
...
class Hungarian extends LanguageTexts {
    ...
    startGame: string = "Játék"
    errorDeckOfCardsAPI: string = "Hiba történt a Deck of Cards API-val való kommunikáció során. Kérlek, próbáld újra, és ellenőrizd, hogy a hiba továbbra is fennáll-e."
    errorModalTitle: string = "Hiba"
}